...
).select("fema_declaration_string", "last_refresh", "place_code")
...
csv_fema_data = csv_data.select("fema_declaration_string", "last_refresh", "place_code")
...
window_spec = Window.orderBy("fema_declaration_string")  # Redoslijed po deklaraciji
femaDIM = (
    combined_fema_data
